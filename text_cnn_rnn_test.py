#!/usr/bin/env python
# -*- coding: utf-8 -*-
# @Time    : 8/15/2018 10:41 AM
# @Author  : SkullFang
# @Contact : yzhang.private@gmail.com
# @File    : text_cnn_rnn_test.py
# @Software: PyCharm
import numpy as np
...
class TextCNNRNN(object):
	def __init__(self, embedding_mat, non_static, hidden_unit, sequence_length, max_pool_size,
        ...
        #embedding_mat
        #non_static 判断是否是训练
        #hidden_unit,隐藏层神经元 配置中为300
        #sequence_length 每一条输入的长度
        #max_pool-size，最大池化层的的尺寸
		#num_classes 类别的多少 这是通过data_helper 里面的函数求出来的
		#embedding_size ？
		#filter_size 过滤器的大小 配置中为3,4,5
